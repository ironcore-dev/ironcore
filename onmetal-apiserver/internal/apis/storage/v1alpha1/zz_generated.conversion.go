...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.BucketPoolCondition)(nil), (*storage.BucketPoolCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BucketPoolCondition_To_storage_BucketPoolCondition(a.(*v1alpha1.BucketPoolCondition), b.(*storage.BucketPoolCondition), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*storage.BucketPoolCondition)(nil), (*v1alpha1.BucketPoolCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_storage_BucketPoolCondition_To_v1alpha1_BucketPoolCondition(a.(*storage.BucketPoolCondition), b.(*v1alpha1.BucketPoolCondition), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BucketPoolCondition_To_storage_BucketPoolCondition(in *v1alpha1.BucketPoolCondition, out *storage.BucketPoolCondition, s conversion.Scope) error {
...
func Convert_v1alpha1_BucketPoolCondition_To_storage_BucketPoolCondition(in *v1alpha1.BucketPoolCondition, out *storage.BucketPoolCondition, s conversion.Scope) error {
	return autoConvert_v1alpha1_BucketPoolCondition_To_storage_BucketPoolCondition(in, out, s)
}

func autoConvert_storage_BucketPoolCondition_To_v1alpha1_BucketPoolCondition(in *storage.BucketPoolCondition, out *v1alpha1.BucketPoolCondition, s conversion.Scope) error {
	out.Type = v1alpha1.BucketPoolConditionType(in.Type)
	out.Status = v1.ConditionStatus(in.Status)
	out.Reason = in.Reason
	out.Message = in.Message
	out.ObservedGeneration = in.ObservedGeneration
...
func Convert_storage_BucketPoolCondition_To_v1alpha1_BucketPoolCondition(in *storage.BucketPoolCondition, out *v1alpha1.BucketPoolCondition, s conversion.Scope) error {
...
func autoConvert_storage_BucketPoolStatus_To_v1alpha1_BucketPoolStatus(in *storage.BucketPoolStatus, out *v1alpha1.BucketPoolStatus, s conversion.Scope) error {
	...
	out.Conditions = *(*[]v1alpha1.BucketPoolCondition)(unsafe.Pointer(&in.Conditions))
	out.AvailableBucketClasses = *(*[]v1.LocalObjectReference)(unsafe.Pointer(&in.AvailableBucketClasses))
	out.Available = *(*v1.ResourceList)(unsafe.Pointer(&in.Available))
	out.Used = *(*v1.ResourceList)(unsafe.Pointer(&in.Used))
	return nil
