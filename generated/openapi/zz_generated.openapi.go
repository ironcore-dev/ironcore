...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/onmetal/onmetal-api/apis/networking/v1alpha1.VirtualIPRoutingSubsetTarget": schema_onmetal_api_apis_networking_v1alpha1_VirtualIPRoutingSubsetTarget(ref),
...
func schema_onmetal_api_apis_networking_v1alpha1_NetworkInterfaceBinding(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/onmetal/onmetal-api/apis/common/v1alpha1.IP", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_onmetal_api_apis_networking_v1alpha1_NetworkInterfaceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/onmetal/onmetal-api/apis/networking/v1alpha1.IPSource", "k8s.io/api/core/v1.LocalObjectReference"},
	}
}
...
func schema_onmetal_api_apis_networking_v1alpha1_VirtualIPRoutingSubset(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"networkRef": {
						SchemaProps: spec.SchemaProps{
							Description: "NetworkRef is the network all targets are in.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/onmetal/onmetal-api/apis/common/v1alpha1.LocalUIDReference"),
						},
					},
					"targets": {
						SchemaProps: spec.SchemaProps{
							Description: "Targets are the targets of the virtual IP.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/onmetal/onmetal-api/apis/networking/v1alpha1.VirtualIPRoutingSubsetTarget"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/onmetal/onmetal-api/apis/common/v1alpha1.LocalUIDReference", "github.com/onmetal/onmetal-api/apis/networking/v1alpha1.VirtualIPRoutingSubsetTarget"},
	}
}

func schema_onmetal_api_apis_networking_v1alpha1_VirtualIPRoutingSubsetTarget(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"ip": {
						SchemaProps: spec.SchemaProps{
							Description: "IP is the target ip to route to.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/onmetal/onmetal-api/apis/common/v1alpha1.IP"),
						},
					},
				},
				Required: []string{"name", "uid", "ip"},
			},
		},
		Dependencies: []string{
			"github.com/onmetal/onmetal-api/apis/common/v1alpha1.IP"},
