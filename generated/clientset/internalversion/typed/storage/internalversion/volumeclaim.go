...
type VolumeClaimInterface interface {
	Create(ctx context.Context, volumeClaim *storage.VolumeClaim, opts v1.CreateOptions) (*storage.VolumeClaim, error)
	Update(ctx context.Context, volumeClaim *storage.VolumeClaim, opts v1.UpdateOptions) (*storage.VolumeClaim, error)
	UpdateStatus(ctx context.Context, volumeClaim *storage.VolumeClaim, opts v1.UpdateOptions) (*storage.VolumeClaim, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*storage.VolumeClaim, error)
	List(ctx context.Context, opts v1.ListOptions) (*storage.VolumeClaimList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *storage.VolumeClaim, err error)
...
func newVolumeClaims(c *StorageClient, namespace string) *volumeClaims {
	return &volumeClaims{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *volumeClaims) Get(ctx context.Context, name string, options v1.GetOptions) (result *storage.VolumeClaim, err error) {
	result = &storage.VolumeClaim{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *volumeClaims) List(ctx context.Context, opts v1.ListOptions) (result *storage.VolumeClaimList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &storage.VolumeClaimList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("volumeclaims").
...
func (c *volumeClaims) Create(ctx context.Context, volumeClaim *storage.VolumeClaim, opts v1.CreateOptions) (result *storage.VolumeClaim, err error) {
	result = &storage.VolumeClaim{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("volumeclaims").
...
func (c *volumeClaims) Update(ctx context.Context, volumeClaim *storage.VolumeClaim, opts v1.UpdateOptions) (result *storage.VolumeClaim, err error) {
	result = &storage.VolumeClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumeclaims").
...
func (c *volumeClaims) UpdateStatus(ctx context.Context, volumeClaim *storage.VolumeClaim, opts v1.UpdateOptions) (result *storage.VolumeClaim, err error) {
	result = &storage.VolumeClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumeclaims").
...
func (c *volumeClaims) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *storage.VolumeClaim, err error) {
	result = &storage.VolumeClaim{}
