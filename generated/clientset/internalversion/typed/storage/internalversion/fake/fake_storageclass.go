...
var storageclassesResource = schema.GroupVersionResource{Group: "storage.onmetal.de", Version: "", Resource: "storageclasses"}

var storageclassesKind = schema.GroupVersionKind{Group: "storage.onmetal.de", Version: "", Kind: "StorageClass"}

// Get takes name of the storageClass, and returns the corresponding storageClass object, and an error if there is any.
func (c *FakeStorageClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *storage.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) List(ctx context.Context, opts v1.ListOptions) (result *storage.StorageClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Create(ctx context.Context, storageClass *storage.StorageClass, opts v1.CreateOptions) (result *storage.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Update(ctx context.Context, storageClass *storage.StorageClass, opts v1.UpdateOptions) (result *storage.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(storageclassesResource, name, opts), &storage.StorageClass{})
	return err
}
...
func (c *FakeStorageClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *storage.StorageClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(storageclassesResource, name, pt, data, subresources...), &storage.StorageClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storage.StorageClass), err
