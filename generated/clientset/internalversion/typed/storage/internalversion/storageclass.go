...
type StorageClassInterface interface {
	Create(ctx context.Context, storageClass *storage.StorageClass, opts v1.CreateOptions) (*storage.StorageClass, error)
	Update(ctx context.Context, storageClass *storage.StorageClass, opts v1.UpdateOptions) (*storage.StorageClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*storage.StorageClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*storage.StorageClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *storage.StorageClass, err error)
...
func (c *storageClasses) Create(ctx context.Context, storageClass *storage.StorageClass, opts v1.CreateOptions) (result *storage.StorageClass, err error) {
	result = &storage.StorageClass{}
	err = c.client.Post().
		Resource("storageclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *storageClasses) Update(ctx context.Context, storageClass *storage.StorageClass, opts v1.UpdateOptions) (result *storage.StorageClass, err error) {
	result = &storage.StorageClass{}
	err = c.client.Put().
		Resource("storageclasses").
...
func (c *storageClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *storage.StorageClass, err error) {
	result = &storage.StorageClass{}
