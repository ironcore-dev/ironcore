...
type AliasPrefixRoutingInterface interface {
	Create(ctx context.Context, aliasPrefixRouting *networking.AliasPrefixRouting, opts v1.CreateOptions) (*networking.AliasPrefixRouting, error)
	Update(ctx context.Context, aliasPrefixRouting *networking.AliasPrefixRouting, opts v1.UpdateOptions) (*networking.AliasPrefixRouting, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*networking.AliasPrefixRouting, error)
	List(ctx context.Context, opts v1.ListOptions) (*networking.AliasPrefixRoutingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *networking.AliasPrefixRouting, err error)
...
func newAliasPrefixRoutings(c *NetworkingClient, namespace string) *aliasPrefixRoutings {
...
func (c *aliasPrefixRoutings) Get(ctx context.Context, name string, options v1.GetOptions) (result *networking.AliasPrefixRouting, err error) {
	result = &networking.AliasPrefixRouting{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aliasPrefixRoutings) List(ctx context.Context, opts v1.ListOptions) (result *networking.AliasPrefixRoutingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &networking.AliasPrefixRoutingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("aliasprefixroutings").
...
func (c *aliasPrefixRoutings) Create(ctx context.Context, aliasPrefixRouting *networking.AliasPrefixRouting, opts v1.CreateOptions) (result *networking.AliasPrefixRouting, err error) {
	result = &networking.AliasPrefixRouting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("aliasprefixroutings").
...
func (c *aliasPrefixRoutings) Update(ctx context.Context, aliasPrefixRouting *networking.AliasPrefixRouting, opts v1.UpdateOptions) (result *networking.AliasPrefixRouting, err error) {
	result = &networking.AliasPrefixRouting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aliasprefixroutings").
...
func (c *aliasPrefixRoutings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *networking.AliasPrefixRouting, err error) {
	result = &networking.AliasPrefixRouting{}
