...
type LoadBalancerInterface interface {
	Create(ctx context.Context, loadBalancer *networking.LoadBalancer, opts v1.CreateOptions) (*networking.LoadBalancer, error)
	Update(ctx context.Context, loadBalancer *networking.LoadBalancer, opts v1.UpdateOptions) (*networking.LoadBalancer, error)
	UpdateStatus(ctx context.Context, loadBalancer *networking.LoadBalancer, opts v1.UpdateOptions) (*networking.LoadBalancer, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*networking.LoadBalancer, error)
	List(ctx context.Context, opts v1.ListOptions) (*networking.LoadBalancerList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *networking.LoadBalancer, err error)
...
func newLoadBalancers(c *NetworkingClient, namespace string) *loadBalancers {
...
func (c *loadBalancers) Get(ctx context.Context, name string, options v1.GetOptions) (result *networking.LoadBalancer, err error) {
...
func (c *loadBalancers) List(ctx context.Context, opts v1.ListOptions) (result *networking.LoadBalancerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &networking.LoadBalancerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("loadbalancers").
...
func (c *loadBalancers) Create(ctx context.Context, loadBalancer *networking.LoadBalancer, opts v1.CreateOptions) (result *networking.LoadBalancer, err error) {
	result = &networking.LoadBalancer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loadbalancers").
...
func (c *loadBalancers) Update(ctx context.Context, loadBalancer *networking.LoadBalancer, opts v1.UpdateOptions) (result *networking.LoadBalancer, err error) {
	result = &networking.LoadBalancer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loadbalancers").
...
func (c *loadBalancers) UpdateStatus(ctx context.Context, loadBalancer *networking.LoadBalancer, opts v1.UpdateOptions) (result *networking.LoadBalancer, err error) {
	result = &networking.LoadBalancer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loadbalancers").
...
func (c *loadBalancers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *networking.LoadBalancer, err error) {
	result = &networking.LoadBalancer{}
