...
type MachineClassInterface interface {
	Create(ctx context.Context, machineClass *compute.MachineClass, opts v1.CreateOptions) (*compute.MachineClass, error)
	Update(ctx context.Context, machineClass *compute.MachineClass, opts v1.UpdateOptions) (*compute.MachineClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*compute.MachineClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*compute.MachineClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *compute.MachineClass, err error)
...
func newMachineClasses(c *ComputeClient, namespace string) *machineClasses {
...
func (c *machineClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *compute.MachineClass, err error) {
	result = &compute.MachineClass{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineClasses) List(ctx context.Context, opts v1.ListOptions) (result *compute.MachineClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &compute.MachineClassList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Create(ctx context.Context, machineClass *compute.MachineClass, opts v1.CreateOptions) (result *compute.MachineClass, err error) {
	result = &compute.MachineClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Update(ctx context.Context, machineClass *compute.MachineClass, opts v1.UpdateOptions) (result *compute.MachineClass, err error) {
	result = &compute.MachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *compute.MachineClass, err error) {
	result = &compute.MachineClass{}
