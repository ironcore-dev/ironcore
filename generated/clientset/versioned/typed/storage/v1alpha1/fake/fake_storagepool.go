...
var storagepoolsResource = schema.GroupVersionResource{Group: "storage.onmetal.de", Version: "v1alpha1", Resource: "storagepools"}

var storagepoolsKind = schema.GroupVersionKind{Group: "storage.onmetal.de", Version: "v1alpha1", Kind: "StoragePool"}
...
func (c *FakeStoragePools) UpdateStatus(ctx context.Context, storagePool *v1alpha1.StoragePool, opts v1.UpdateOptions) (*v1alpha1.StoragePool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(storagepoolsResource, "status", storagePool), &v1alpha1.StoragePool{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StoragePool), err
...
func (c *FakeStoragePools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(storagepoolsResource, name, opts), &v1alpha1.StoragePool{})
	return err
}
