...
// List lists all AliasPrefixRoutings in the indexer.
func (s *aliasPrefixRoutingLister) List(selector labels.Selector) (ret []*v1alpha1.AliasPrefixRouting, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.AliasPrefixRouting))
	})
	return ret, err
}
...
// List lists all AliasPrefixRoutings in the indexer for a given namespace.
func (s aliasPrefixRoutingNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AliasPrefixRouting, err error) {
...
// Get retrieves the AliasPrefixRouting from the indexer for a given namespace and name.
func (s aliasPrefixRoutingNamespaceLister) Get(name string) (*v1alpha1.AliasPrefixRouting, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("aliasprefixrouting"), name)
	}
	return obj.(*v1alpha1.AliasPrefixRouting), nil
}
