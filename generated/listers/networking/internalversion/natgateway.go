...
type NATGatewayLister interface {
	...
	List(selector labels.Selector) (ret []*networking.NATGateway, err error)
...
// List lists all NATGateways in the indexer.
func (s *nATGatewayLister) List(selector labels.Selector) (ret []*networking.NATGateway, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*networking.NATGateway))
	})
	return ret, err
}
...
type NATGatewayNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*networking.NATGateway, error)
...
// List lists all NATGateways in the indexer for a given namespace.
func (s nATGatewayNamespaceLister) List(selector labels.Selector) (ret []*networking.NATGateway, err error) {
...
// Get retrieves the NATGateway from the indexer for a given namespace and name.
func (s nATGatewayNamespaceLister) Get(name string) (*networking.NATGateway, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(networking.Resource("natgateway"), name)
	}
	return obj.(*networking.NATGateway), nil
}
