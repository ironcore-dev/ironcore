	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1alpha1().StoragePools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1alpha1().StoragePools().Watch(context.TODO(), options)
			},
		},
		&storagev1alpha1.StoragePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storagePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1alpha1.StoragePool{}, f.defaultInformer)
}
