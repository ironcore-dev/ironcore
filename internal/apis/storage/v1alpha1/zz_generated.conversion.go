...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.EphemeralVolumeSpec)(nil), (*storage.EphemeralVolumeSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_EphemeralVolumeSpec_To_storage_EphemeralVolumeSpec(a.(*v1alpha1.EphemeralVolumeSpec), b.(*storage.EphemeralVolumeSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*storage.EphemeralVolumeSpec)(nil), (*v1alpha1.EphemeralVolumeSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_storage_EphemeralVolumeSpec_To_v1alpha1_EphemeralVolumeSpec(a.(*storage.EphemeralVolumeSpec), b.(*v1alpha1.EphemeralVolumeSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_EphemeralVolumeSpec_To_storage_EphemeralVolumeSpec(in *v1alpha1.EphemeralVolumeSpec, out *storage.EphemeralVolumeSpec, s conversion.Scope) error {
	if err := Convert_v1alpha1_VolumeSpec_To_storage_VolumeSpec(&in.VolumeSpec, &out.VolumeSpec, s); err != nil {
		return err
	}
	out.ReclaimPolicy = storage.ReclaimPolicy(in.ReclaimPolicy)
	return nil
}

// Convert_v1alpha1_EphemeralVolumeSpec_To_storage_EphemeralVolumeSpec is an autogenerated conversion function.
func Convert_v1alpha1_EphemeralVolumeSpec_To_storage_EphemeralVolumeSpec(in *v1alpha1.EphemeralVolumeSpec, out *storage.EphemeralVolumeSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_EphemeralVolumeSpec_To_storage_EphemeralVolumeSpec(in, out, s)
}

func autoConvert_storage_EphemeralVolumeSpec_To_v1alpha1_EphemeralVolumeSpec(in *storage.EphemeralVolumeSpec, out *v1alpha1.EphemeralVolumeSpec, s conversion.Scope) error {
	if err := Convert_storage_VolumeSpec_To_v1alpha1_VolumeSpec(&in.VolumeSpec, &out.VolumeSpec, s); err != nil {
		return err
	}
	out.ReclaimPolicy = v1alpha1.ReclaimPolicy(in.ReclaimPolicy)
	return nil
}

// Convert_storage_EphemeralVolumeSpec_To_v1alpha1_EphemeralVolumeSpec is an autogenerated conversion function.
func Convert_storage_EphemeralVolumeSpec_To_v1alpha1_EphemeralVolumeSpec(in *storage.EphemeralVolumeSpec, out *v1alpha1.EphemeralVolumeSpec, s conversion.Scope) error {
	return autoConvert_storage_EphemeralVolumeSpec_To_v1alpha1_EphemeralVolumeSpec(in, out, s)
}
...
func autoConvert_v1alpha1_VolumeTemplateSpec_To_storage_VolumeTemplateSpec(in *v1alpha1.VolumeTemplateSpec, out *storage.VolumeTemplateSpec, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_EphemeralVolumeSpec_To_storage_EphemeralVolumeSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_storage_VolumeTemplateSpec_To_v1alpha1_VolumeTemplateSpec(in *storage.VolumeTemplateSpec, out *v1alpha1.VolumeTemplateSpec, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_storage_EphemeralVolumeSpec_To_v1alpha1_EphemeralVolumeSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}
