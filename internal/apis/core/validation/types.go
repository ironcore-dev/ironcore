...
func ValidateIPPrefix(ipFamily corev1.IPFamily, ipPrefix corev1alpha1.IPPrefix, fldPath *field.Path) field.ErrorList {
...
func ValidateIP(ipFamily corev1.IPFamily, ip corev1alpha1.IP, fldPath *field.Path) field.ErrorList {
	var allErrs field.ErrorList
