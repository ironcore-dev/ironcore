...
<a href="#compute.api.onmetal.de/v1alpha1.NetworkInterface">NetworkInterface</a>
</li></ul>
...
<code>spec</code><br/>
<em>
<a href="#compute.api.onmetal.de/v1alpha1.NetworkInterfaceSpec">
...
<em>
<a href="https://v1-23.docs.kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#ipfamily-v1-core">
...
<code>ips</code><br/>
<em>
<a href="#compute.api.onmetal.de/v1alpha1.IPSource">
[]IPSource
</a>
</em>
</td>
...
<h3 id="compute.api.onmetal.de/v1alpha1.EphemeralPrefixSource">EphemeralPrefixSource
</h3>
<p>
(<em>Appears on:</em><a href="#compute.api.onmetal.de/v1alpha1.IPSource">IPSource</a>)
</p>
<div>
</div>
<table>
...
<em>
<a href="#compute.api.onmetal.de/v1alpha1.PrefixTemplate">
PrefixTemplate
</a>
</em>
</td>
...
<h3 id="compute.api.onmetal.de/v1alpha1.IPSource">IPSource
</h3>
<p>
(<em>Appears on:</em><a href="#compute.api.onmetal.de/v1alpha1.NetworkInterfaceSpec">NetworkInterfaceSpec</a>)
</p>
<div>
</div>
<table>
...
<em>
<a href="#compute.api.onmetal.de/v1alpha1.EphemeralPrefixSource">
...
<h3 id="compute.api.onmetal.de/v1alpha1.NetworkInterfaceSpec">NetworkInterfaceSpec
</h3>
<p>
...
<h3 id="compute.api.onmetal.de/v1alpha1.PrefixTemplate">PrefixTemplate
</h3>
<p>
(<em>Appears on:</em><a href="#compute.api.onmetal.de/v1alpha1.EphemeralPrefixSource">EphemeralPrefixSource</a>)
</p>
<div>
</div>
<table>
...
on git commit <code>eef9659</code>.
</em></p>
