...
import (
	...
	endpoints2 "github.com/onmetal/onmetal-api/poollet/machinepoollet/endpoints"
...
func (o *EndpointsOptions) NewEndpoints(ctx context.Context, cfg *rest.Config) (endpoints2.Endpoints, error) {
	switch o.Type {
	case EndpointsTypeNone:
		return endpoints2.NoEndpoints{}, nil
	case EndpointsTypeLoadBalancer:
		return endpoints2.NewLoadBalancerServiceEndpoints(ctx, cfg, endpoints2.LoadBalancerServiceEndpointsOptions{
			Namespace:   o.getNamespace(),
			ServiceName: o.ServiceName,
			PortName:    o.PortName,
		})
	case EndpointsTypeNodePort:
		return endpoints2.NewNodePortServiceEndpoints(ctx, cfg, endpoints2.NodePortServiceEndpointsOptions{
			Namespace:        o.getNamespace(),
			ServiceName:      o.ServiceName,
			PortName:         o.PortName,
	...
	case EndpointsTypeStaticHostname:
		return endpoints2.NewStaticHostName(o.StaticHostname, o.StaticPort)
	default:
...
func SetupEndpointsWithManager(eps endpoints2.Endpoints, mgr ctrl.Manager) error {
