...
type Generator[O irimeta.Object] interface {
	Source[O]
	healthz.HealthChecker
	manager.Runnable
}

type event[O irimeta.Object] struct {
...
type oldNewMapEntry[O irimeta.Object] struct {
	Old     *O
	Current *O
}

type oldNewMap[O irimeta.Object] map[string]*oldNewMapEntry[O]
...
type handler[O irimeta.Object] struct {
	Handler[O]
}

type generator[O irimeta.Object] struct {
	mu sync.RWMutex
...
func NewGenerator[O irimeta.Object](list func(ctx context.Context) ([]O, error), opts GeneratorOptions) Generator[O] {
...
type handlerRegistration[O irimeta.Object] struct {
