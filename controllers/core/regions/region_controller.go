...
//+kubebuilder:rbac:groups=core.onmetal.de,resources=regions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.onmetal.de,resources=regions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.onmetal.de,resources=regions/finalizers,verbs=update
