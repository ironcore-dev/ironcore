...
// SSHPublicKeyReconciler reconciles a SSHPublicKey object
type SSHPublicKeyReconciler struct {
	client.Client
...
// the SSHPublicKey object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.8.3/pkg/reconcile
func (r *SSHPublicKeyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *SSHPublicKeyReconciler) SetupWithManager(mgr ctrl.Manager) error {
