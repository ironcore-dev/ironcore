...
//+kubebuilder:rbac:groups=compute.onmetal.de,resources=flavors,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=compute.onmetal.de,resources=flavors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=compute.onmetal.de,resources=flavors/finalizers,verbs=update
