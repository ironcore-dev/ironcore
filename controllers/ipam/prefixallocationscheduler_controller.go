...
func (r *PrefixAllocationSchedulerReconciler) reconcileExists(ctx context.Context, log logr.Logger, allocation *ipamv1alpha1.PrefixAllocation) (ctrl.Result, error) {
...
func (r *PrefixAllocationSchedulerReconciler) patchReadiness(ctx context.Context, allocation *ipamv1alpha1.PrefixAllocation, readyCond ipamv1alpha1.PrefixAllocationCondition) error {
...
func (r *PrefixAllocationSchedulerReconciler) prefixRefForAllocation(ctx context.Context, log logr.Logger, allocation *ipamv1alpha1.PrefixAllocation) (*ipamv1alpha1.PrefixReference, error) {
	...
	case ipamv1alpha1.ClusterPrefixKind:
...
func (r *PrefixAllocationSchedulerReconciler) clusterPrefixRef(ctx context.Context, allocation *ipamv1alpha1.PrefixAllocation, sel labels.Selector) (string, error) {
...
func (r *PrefixAllocationSchedulerReconciler) prefixRef(ctx context.Context, allocation *ipamv1alpha1.PrefixAllocation, sel labels.Selector) (string, error) {
...
func IsPrefixAllocationInTerminalState(allocation *ipamv1alpha1.PrefixAllocation) bool {
	readyCond := &ipamv1alpha1.PrefixAllocationCondition{}
	conditionutils.MustFindSlice(allocation.Status.Conditions, string(ipamv1alpha1.PrefixAllocationReady), readyCond)
	switch {
	case readyCond.Status == corev1.ConditionFalse && readyCond.Reason == ipamv1alpha1.PrefixAllocationReadyReasonFailed:
		return true
...
func (r *PrefixAllocationSchedulerReconciler) reconcile(ctx context.Context, log logr.Logger, allocation *ipamv1alpha1.PrefixAllocation) (ctrl.Result, error) {
	...
	if ref == nil {
		...
		if err := r.patchReadiness(ctx, allocation, ipamv1alpha1.PrefixAllocationCondition{
...
func (r *PrefixAllocationSchedulerReconciler) SetupWithManager(mgr manager.Manager) error {
	...
	if err := mgr.GetFieldIndexer().IndexField(ctx, &ipamv1alpha1.PrefixAllocation{}, prefixAllocationSpecIfUnscheduledOnClusterPrefixField, func(obj client.Object) []string {
		allocation := obj.(*ipamv1alpha1.PrefixAllocation)
		if allocation.Spec.PrefixRef != nil {
			return nil
		}
		if prefixSelector := allocation.Spec.PrefixSelector; prefixSelector == nil || prefixSelector.Kind != ipamv1alpha1.ClusterPrefixKind {
			return nil
		}
		return []string{""}
	}); err != nil {
	...
	if err := mgr.GetFieldIndexer().IndexField(ctx, &ipamv1alpha1.PrefixAllocation{}, prefixAllocationSpecIfUnscheduledOnPrefixField, func(obj client.Object) []string {
		allocation := obj.(*ipamv1alpha1.PrefixAllocation)
		if allocation.Spec.PrefixRef != nil {
			return nil
		}
		if prefixSelector := allocation.Spec.PrefixSelector; prefixSelector == nil || prefixSelector.Kind != ipamv1alpha1.PrefixKind {
			return nil
		}
		return []string{""}
	}); err != nil {
