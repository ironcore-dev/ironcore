...
type PrefixAllocationer interface {
	...
	PrefixRef() *ipamv1alpha1.PrefixReference
	Request() ipamv1alpha1.PrefixAllocationRequest
	Result() ipamv1alpha1.PrefixAllocationResult
...
type PrefixRequester interface {
	...
	Request() ipamv1alpha1.PrefixAllocationRequest
	PrefixRef() *ipamv1alpha1.PrefixReference
	PrefixSelector() *ipamv1alpha1.PrefixSelector
}
...
type PrefixAllocation ipamv1alpha1.PrefixAllocation

func (p *PrefixAllocation) Object() client.Object {
	return (*ipamv1alpha1.PrefixAllocation)(p)
}

func (p *PrefixAllocation) PrefixRef() *ipamv1alpha1.PrefixReference {
	return p.Spec.PrefixRef
}

func (p *PrefixAllocation) Request() ipamv1alpha1.PrefixAllocationRequest {
	return p.Spec.PrefixAllocationRequest
}

func (p *PrefixAllocation) Result() ipamv1alpha1.PrefixAllocationResult {
	return p.Status.PrefixAllocationResult
}

func (p *PrefixAllocation) ReadyState() PrefixAllocationReadyState {
	cond := &ipamv1alpha1.PrefixAllocationCondition{}
	conditionutils.MustFindSlice(p.Status.Conditions, string(ipamv1alpha1.PrefixAllocationReady), cond)
	switch {
	case cond.Status == corev1.ConditionTrue:
		return PrefixAllocationSucceeded
	case cond.Status == corev1.ConditionFalse && cond.Reason == ipamv1alpha1.PrefixAllocationReadyReasonPending:
...
type ClusterPrefixAllocation ipamv1alpha1.ClusterPrefixAllocation

func (a *ClusterPrefixAllocation) Object() client.Object {
	return (*ipamv1alpha1.ClusterPrefixAllocation)(a)
}

func (a *ClusterPrefixAllocation) PrefixRef() *ipamv1alpha1.PrefixReference {
...
func (a *ClusterPrefixAllocation) Request() ipamv1alpha1.PrefixAllocationRequest {
...
func (a *ClusterPrefixAllocation) Result() ipamv1alpha1.PrefixAllocationResult {
	return ipamv1alpha1.PrefixAllocationResult{
		Prefix: a.Status.Prefix,
	}
}

func (a *ClusterPrefixAllocation) ReadyState() PrefixAllocationReadyState {
	cond := &ipamv1alpha1.ClusterPrefixAllocationCondition{}
	conditionutils.MustFindSlice(a.Status.Conditions, string(ipamv1alpha1.ClusterPrefixAllocationReady), cond)
	switch {
	case cond.Status == corev1.ConditionTrue:
		return PrefixAllocationSucceeded
	case cond.Status == corev1.ConditionFalse && cond.Reason == ipamv1alpha1.ClusterPrefixAllocationReadyReasonPending:
		return PrefixAllocationPending
	case cond.Status == corev1.ConditionFalse:
		return PrefixAllocationFailed
	default:
...
func CanIPSetFitRequest(set *netaddr.IPSet, request ipamv1alpha1.PrefixAllocationRequest) bool {
	switch {
...
func CanPrefixFitRequest(prefix *ipamv1alpha1.Prefix, request ipamv1alpha1.PrefixAllocationRequest) bool {
...
func CanClusterPrefixFitRequest(clusterPrefix *ipamv1alpha1.ClusterPrefix, request ipamv1alpha1.PrefixAllocationRequest) bool {
...
func RemoveFreePrefixForRequest(set *netaddr.IPSet, allocation ipamv1alpha1.PrefixAllocationRequest) (netaddr.IPPrefix, netaddr.IPRange, *netaddr.IPSet, bool) {
	switch {
...
func PrefixAllocationRequestMatchesAllocator(request ipamv1alpha1.PrefixAllocationRequest, allocation PrefixAllocationer) bool {
...
func CreateAllocator(scheme *runtime.Scheme, mapper meta.RESTMapper, requester PrefixRequester) (PrefixAllocationer, error) {
	...
	if ok {
		...
		spec := ipamv1alpha1.ClusterPrefixAllocationSpec{
