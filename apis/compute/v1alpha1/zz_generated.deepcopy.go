...
func (in *ConsoleSpec) DeepCopyInto(out *ConsoleSpec) {
	*out = *in
	...
	if in.LighthouseClientConfig != nil {
		in, out := &in.LighthouseClientConfig, &out.LighthouseClientConfig
		*out = new(ConsoleClientConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ConsoleStatus) DeepCopyInto(out *ConsoleStatus) {
	*out = *in
	if in.ServiceClientConfig != nil {
		in, out := &in.ServiceClientConfig, &out.ServiceClientConfig
		*out = new(ConsoleClientConfig)
		(*in).DeepCopyInto(*out)
	}
}
