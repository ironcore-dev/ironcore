...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EmptyDiskVolumeStatus)(nil), (*compute.EmptyDiskVolumeStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_EmptyDiskVolumeStatus_To_compute_EmptyDiskVolumeStatus(a.(*EmptyDiskVolumeStatus), b.(*compute.EmptyDiskVolumeStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*compute.EmptyDiskVolumeStatus)(nil), (*EmptyDiskVolumeStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_compute_EmptyDiskVolumeStatus_To_v1alpha1_EmptyDiskVolumeStatus(a.(*compute.EmptyDiskVolumeStatus), b.(*EmptyDiskVolumeStatus), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ReferencedVolumeStatus)(nil), (*compute.ReferencedVolumeStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ReferencedVolumeStatus_To_compute_ReferencedVolumeStatus(a.(*ReferencedVolumeStatus), b.(*compute.ReferencedVolumeStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*compute.ReferencedVolumeStatus)(nil), (*ReferencedVolumeStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_compute_ReferencedVolumeStatus_To_v1alpha1_ReferencedVolumeStatus(a.(*compute.ReferencedVolumeStatus), b.(*ReferencedVolumeStatus), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*VolumeSourceStatus)(nil), (*compute.VolumeSourceStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VolumeSourceStatus_To_compute_VolumeSourceStatus(a.(*VolumeSourceStatus), b.(*compute.VolumeSourceStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*compute.VolumeSourceStatus)(nil), (*VolumeSourceStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_compute_VolumeSourceStatus_To_v1alpha1_VolumeSourceStatus(a.(*compute.VolumeSourceStatus), b.(*VolumeSourceStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_EmptyDiskVolumeStatus_To_compute_EmptyDiskVolumeStatus(in *EmptyDiskVolumeStatus, out *compute.EmptyDiskVolumeStatus, s conversion.Scope) error {
...
func Convert_v1alpha1_EmptyDiskVolumeStatus_To_compute_EmptyDiskVolumeStatus(in *EmptyDiskVolumeStatus, out *compute.EmptyDiskVolumeStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_EmptyDiskVolumeStatus_To_compute_EmptyDiskVolumeStatus(in, out, s)
}

func autoConvert_compute_EmptyDiskVolumeStatus_To_v1alpha1_EmptyDiskVolumeStatus(in *compute.EmptyDiskVolumeStatus, out *EmptyDiskVolumeStatus, s conversion.Scope) error {
	out.Size = (*resource.Quantity)(unsafe.Pointer(in.Size))
	return nil
}

// Convert_compute_EmptyDiskVolumeStatus_To_v1alpha1_EmptyDiskVolumeStatus is an autogenerated conversion function.
func Convert_compute_EmptyDiskVolumeStatus_To_v1alpha1_EmptyDiskVolumeStatus(in *compute.EmptyDiskVolumeStatus, out *EmptyDiskVolumeStatus, s conversion.Scope) error {
...
func autoConvert_compute_NetworkInterfaceStatus_To_v1alpha1_NetworkInterfaceStatus(in *compute.NetworkInterfaceStatus, out *NetworkInterfaceStatus, s conversion.Scope) error {
	...
	out.IPs = *(*[]commonv1alpha1.IP)(unsafe.Pointer(&in.IPs))
	out.VirtualIP = (*commonv1alpha1.IP)(unsafe.Pointer(in.VirtualIP))
	out.State = NetworkInterfaceState(in.State)
	out.LastStateTransitionTime = (*metav1.Time)(unsafe.Pointer(in.LastStateTransitionTime))
...
func autoConvert_v1alpha1_ReferencedVolumeStatus_To_compute_ReferencedVolumeStatus(in *ReferencedVolumeStatus, out *compute.ReferencedVolumeStatus, s conversion.Scope) error {
...
func Convert_v1alpha1_ReferencedVolumeStatus_To_compute_ReferencedVolumeStatus(in *ReferencedVolumeStatus, out *compute.ReferencedVolumeStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_ReferencedVolumeStatus_To_compute_ReferencedVolumeStatus(in, out, s)
}

func autoConvert_compute_ReferencedVolumeStatus_To_v1alpha1_ReferencedVolumeStatus(in *compute.ReferencedVolumeStatus, out *ReferencedVolumeStatus, s conversion.Scope) error {
	out.Driver = in.Driver
	out.Handle = in.Handle
	return nil
}
...
func Convert_compute_ReferencedVolumeStatus_To_v1alpha1_ReferencedVolumeStatus(in *compute.ReferencedVolumeStatus, out *ReferencedVolumeStatus, s conversion.Scope) error {
...
func autoConvert_v1alpha1_VolumeSourceStatus_To_compute_VolumeSourceStatus(in *VolumeSourceStatus, out *compute.VolumeSourceStatus, s conversion.Scope) error {
...
func Convert_v1alpha1_VolumeSourceStatus_To_compute_VolumeSourceStatus(in *VolumeSourceStatus, out *compute.VolumeSourceStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_VolumeSourceStatus_To_compute_VolumeSourceStatus(in, out, s)
}

func autoConvert_compute_VolumeSourceStatus_To_v1alpha1_VolumeSourceStatus(in *compute.VolumeSourceStatus, out *VolumeSourceStatus, s conversion.Scope) error {
	out.EmptyDisk = (*EmptyDiskVolumeStatus)(unsafe.Pointer(in.EmptyDisk))
	out.Referenced = (*ReferencedVolumeStatus)(unsafe.Pointer(in.Referenced))
	return nil
}

// Convert_compute_VolumeSourceStatus_To_v1alpha1_VolumeSourceStatus is an autogenerated conversion function.
func Convert_compute_VolumeSourceStatus_To_v1alpha1_VolumeSourceStatus(in *compute.VolumeSourceStatus, out *VolumeSourceStatus, s conversion.Scope) error {
