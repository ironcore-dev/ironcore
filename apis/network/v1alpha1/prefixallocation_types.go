...
//+kubebuilder:printcolumn:name="RRange",type=string,JSONPath=`.spec.range`
//+kubebuilder:printcolumn:name="RRLen",type=string,JSONPath=`.spec.rangeLength`
//+kubebuilder:printcolumn:name="Prefix",type=string,JSONPath=`.status.prefix`
//+kubebuilder:printcolumn:name="Range",type=string,JSONPath=`.status.range`
...
func init() {
	SchemeBuilder.Register(&PrefixAllocation{}, &PrefixAllocationList{})
}
