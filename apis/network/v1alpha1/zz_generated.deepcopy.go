...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPAMRangeElement) DeepCopyInto(out *IPAMRangeElement) {
	*out = *in
	if in.CIDR != nil {
		in, out := &in.CIDR, &out.CIDR
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPAMRangeElement.
func (in *IPAMRangeElement) DeepCopy() *IPAMRangeElement {
	if in == nil {
		return nil
	}
	out := new(IPAMRangeElement)
...
func (in *IPAMRangeSpec) DeepCopyInto(out *IPAMRangeSpec) {
	*out = *in
	...
	if in.Elements != nil {
		...
		*out = make([]IPAMRangeElement, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
