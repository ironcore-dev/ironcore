...
// IsTerminal reports whether the Readiness is a terminal / final Readiness that cannot be changed from.
func (r1 Readiness) IsTerminal() bool {
	switch r1 {
