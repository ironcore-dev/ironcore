...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case storagev1alpha1.SchemeGroupVersion.WithResource("volumesnapshotcontents"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Storage().V1alpha1().VolumeSnapshotContents().Informer()}, nil
