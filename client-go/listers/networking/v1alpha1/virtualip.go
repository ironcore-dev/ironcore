...
type VirtualIPLister interface {
	...
	List(selector labels.Selector) (ret []*networkingv1alpha1.VirtualIP, err error)
...
type virtualIPLister struct {
	listers.ResourceIndexer[*networkingv1alpha1.VirtualIP]
}

// NewVirtualIPLister returns a new VirtualIPLister.
func NewVirtualIPLister(indexer cache.Indexer) VirtualIPLister {
	return &virtualIPLister{listers.New[*networkingv1alpha1.VirtualIP](indexer, networkingv1alpha1.Resource("virtualip"))}
}

// VirtualIPs returns an object that can list and get VirtualIPs.
func (s *virtualIPLister) VirtualIPs(namespace string) VirtualIPNamespaceLister {
	return virtualIPNamespaceLister{listers.NewNamespaced[*networkingv1alpha1.VirtualIP](s.ResourceIndexer, namespace)}
}
...
type VirtualIPNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*networkingv1alpha1.VirtualIP, error)
