...
type NetworkPolicyLister interface {
	...
	List(selector labels.Selector) (ret []*networkingv1alpha1.NetworkPolicy, err error)
...
type networkPolicyLister struct {
	listers.ResourceIndexer[*networkingv1alpha1.NetworkPolicy]
}
...
func NewNetworkPolicyLister(indexer cache.Indexer) NetworkPolicyLister {
	return &networkPolicyLister{listers.New[*networkingv1alpha1.NetworkPolicy](indexer, networkingv1alpha1.Resource("networkpolicy"))}
}

// NetworkPolicies returns an object that can list and get NetworkPolicies.
func (s *networkPolicyLister) NetworkPolicies(namespace string) NetworkPolicyNamespaceLister {
	return networkPolicyNamespaceLister{listers.NewNamespaced[*networkingv1alpha1.NetworkPolicy](s.ResourceIndexer, namespace)}
}
...
type NetworkPolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*networkingv1alpha1.NetworkPolicy, error)
