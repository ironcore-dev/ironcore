...
// AliasPrefixApplyConfiguration represents an declarative configuration of the AliasPrefix type for use
// with apply.
...
// AliasPrefix constructs an declarative configuration of the AliasPrefix type for use with
// apply.
func AliasPrefix(name, namespace string) *AliasPrefixApplyConfiguration {
	b := &AliasPrefixApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("AliasPrefix")
	b.WithAPIVersion("networking.api.onmetal.de/v1alpha1")
	return b
}

// ExtractAliasPrefix extracts the applied configuration owned by fieldManager from
// aliasPrefix. If no managedFields are found in aliasPrefix for fieldManager, a
// AliasPrefixApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// aliasPrefix must be a unmodified AliasPrefix API object that was retrieved from the Kubernetes API.
// ExtractAliasPrefix provides a way to perform a extract/modify-in-place/apply workflow.
...
func ExtractAliasPrefix(aliasPrefix *networkingv1alpha1.AliasPrefix, fieldManager string) (*AliasPrefixApplyConfiguration, error) {
	return extractAliasPrefix(aliasPrefix, fieldManager, "")
}

// ExtractAliasPrefixStatus is the same as ExtractAliasPrefix except
...
func ExtractAliasPrefixStatus(aliasPrefix *networkingv1alpha1.AliasPrefix, fieldManager string) (*AliasPrefixApplyConfiguration, error) {
	return extractAliasPrefix(aliasPrefix, fieldManager, "status")
}

func extractAliasPrefix(aliasPrefix *networkingv1alpha1.AliasPrefix, fieldManager string, subresource string) (*AliasPrefixApplyConfiguration, error) {
	b := &AliasPrefixApplyConfiguration{}
	err := managedfields.ExtractInto(aliasPrefix, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1alpha1.AliasPrefix"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(aliasPrefix.Name)
	b.WithNamespace(aliasPrefix.Namespace)
...
func (b *AliasPrefixApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
