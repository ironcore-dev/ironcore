...
// NATGatewayIPStatusApplyConfiguration represents an declarative configuration of the NATGatewayIPStatus type for use
// with apply.
...
// NATGatewayIPStatusApplyConfiguration constructs an declarative configuration of the NATGatewayIPStatus type for use with
// apply.
func NATGatewayIPStatus() *NATGatewayIPStatusApplyConfiguration {
	return &NATGatewayIPStatusApplyConfiguration{}
}
