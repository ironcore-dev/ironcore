...
// AliasPrefixStatusApplyConfiguration represents an declarative configuration of the AliasPrefixStatus type for use
// with apply.
type AliasPrefixStatusApplyConfiguration struct {
	Prefix *v1alpha1.IPPrefix `json:"prefix,omitempty"`
}

// AliasPrefixStatusApplyConfiguration constructs an declarative configuration of the AliasPrefixStatus type for use with
// apply.
func AliasPrefixStatus() *AliasPrefixStatusApplyConfiguration {
	return &AliasPrefixStatusApplyConfiguration{}
}
