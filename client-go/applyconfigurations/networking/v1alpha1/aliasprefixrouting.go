...
// AliasPrefixRoutingApplyConfiguration represents an declarative configuration of the AliasPrefixRouting type for use
// with apply.
...
// AliasPrefixRouting constructs an declarative configuration of the AliasPrefixRouting type for use with
// apply.
func AliasPrefixRouting(name, namespace string) *AliasPrefixRoutingApplyConfiguration {
	b := &AliasPrefixRoutingApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("AliasPrefixRouting")
	b.WithAPIVersion("networking.api.onmetal.de/v1alpha1")
	return b
}

// ExtractAliasPrefixRouting extracts the applied configuration owned by fieldManager from
// aliasPrefixRouting. If no managedFields are found in aliasPrefixRouting for fieldManager, a
// AliasPrefixRoutingApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// aliasPrefixRouting must be a unmodified AliasPrefixRouting API object that was retrieved from the Kubernetes API.
// ExtractAliasPrefixRouting provides a way to perform a extract/modify-in-place/apply workflow.
...
func ExtractAliasPrefixRouting(aliasPrefixRouting *networkingv1alpha1.AliasPrefixRouting, fieldManager string) (*AliasPrefixRoutingApplyConfiguration, error) {
	return extractAliasPrefixRouting(aliasPrefixRouting, fieldManager, "")
}

// ExtractAliasPrefixRoutingStatus is the same as ExtractAliasPrefixRouting except
...
func ExtractAliasPrefixRoutingStatus(aliasPrefixRouting *networkingv1alpha1.AliasPrefixRouting, fieldManager string) (*AliasPrefixRoutingApplyConfiguration, error) {
	return extractAliasPrefixRouting(aliasPrefixRouting, fieldManager, "status")
}

func extractAliasPrefixRouting(aliasPrefixRouting *networkingv1alpha1.AliasPrefixRouting, fieldManager string, subresource string) (*AliasPrefixRoutingApplyConfiguration, error) {
	b := &AliasPrefixRoutingApplyConfiguration{}
	err := managedfields.ExtractInto(aliasPrefixRouting, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1alpha1.AliasPrefixRouting"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(aliasPrefixRouting.Name)
	b.WithNamespace(aliasPrefixRouting.Namespace)
...
func (b *AliasPrefixRoutingApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
