...
type networkInterfaces struct {
	*gentype.ClientWithListAndApply[*v1alpha1.NetworkInterface, *v1alpha1.NetworkInterfaceList, *networkingv1alpha1.NetworkInterfaceApplyConfiguration]
}
...
func newNetworkInterfaces(c *NetworkingV1alpha1Client, namespace string) *networkInterfaces {
	return &networkInterfaces{
		gentype.NewClientWithListAndApply[*v1alpha1.NetworkInterface, *v1alpha1.NetworkInterfaceList, *networkingv1alpha1.NetworkInterfaceApplyConfiguration](
			"networkinterfaces",
			c.RESTClient(),
