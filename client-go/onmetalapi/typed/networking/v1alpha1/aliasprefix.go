...
func newAliasPrefixes(c *NetworkingV1alpha1Client, namespace string) *aliasPrefixes {
...
func (c *aliasPrefixes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AliasPrefix, err error) {
	result = &v1alpha1.AliasPrefix{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aliasPrefixes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AliasPrefixList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AliasPrefixList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("aliasprefixes").
...
func (c *aliasPrefixes) Create(ctx context.Context, aliasPrefix *v1alpha1.AliasPrefix, opts v1.CreateOptions) (result *v1alpha1.AliasPrefix, err error) {
	result = &v1alpha1.AliasPrefix{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("aliasprefixes").
...
func (c *aliasPrefixes) Update(ctx context.Context, aliasPrefix *v1alpha1.AliasPrefix, opts v1.UpdateOptions) (result *v1alpha1.AliasPrefix, err error) {
	result = &v1alpha1.AliasPrefix{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aliasprefixes").
...
func (c *aliasPrefixes) UpdateStatus(ctx context.Context, aliasPrefix *v1alpha1.AliasPrefix, opts v1.UpdateOptions) (result *v1alpha1.AliasPrefix, err error) {
	result = &v1alpha1.AliasPrefix{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aliasprefixes").
...
func (c *aliasPrefixes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AliasPrefix, err error) {
	result = &v1alpha1.AliasPrefix{}
...
func (c *aliasPrefixes) Apply(ctx context.Context, aliasPrefix *networkingv1alpha1.AliasPrefixApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.AliasPrefix, err error) {
	if aliasPrefix == nil {
		return nil, fmt.Errorf("aliasPrefix provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
	data, err := json.Marshal(aliasPrefix)
	if err != nil {
		return nil, err
	}
	name := aliasPrefix.Name
	if name == nil {
		return nil, fmt.Errorf("aliasPrefix.Name must be provided to Apply")
	}
	result = &v1alpha1.AliasPrefix{}
...
func (c *aliasPrefixes) ApplyStatus(ctx context.Context, aliasPrefix *networkingv1alpha1.AliasPrefixApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.AliasPrefix, err error) {
	if aliasPrefix == nil {
		return nil, fmt.Errorf("aliasPrefix provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
