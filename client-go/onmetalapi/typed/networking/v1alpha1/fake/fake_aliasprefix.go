...
func (c *FakeAliasPrefixes) Apply(ctx context.Context, aliasPrefix *networkingv1alpha1.AliasPrefixApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.AliasPrefix, err error) {
	if aliasPrefix == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(aliasprefixesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.AliasPrefix{})
...
func (c *FakeAliasPrefixes) ApplyStatus(ctx context.Context, aliasPrefix *networkingv1alpha1.AliasPrefixApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.AliasPrefix, err error) {
	if aliasPrefix == nil {
		return nil, fmt.Errorf("aliasPrefix provided to Apply must not be nil")
	}
	data, err := json.Marshal(aliasPrefix)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(aliasprefixesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha1.AliasPrefix{})
