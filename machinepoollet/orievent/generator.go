...
type oldNewMapEntry[O Object] struct {
	Old     *O
	Current *O
}

type oldNewMap[O Object] map[string]*oldNewMapEntry[O]
...
type generator[O Object] struct {
	mu sync.RWMutex
...
func NewGenerator[O Object](list func(ctx context.Context) ([]O, error), opts GeneratorOptions) Generator[O] {
...
type handlerRegistration[O Object] struct {
