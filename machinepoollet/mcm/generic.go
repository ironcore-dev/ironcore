...
func getCapabilities(oriCaps *ori.MachineResources) capabilities {
	return capabilities{
...
func (g *Generic) GetMachineClassFor(ctx context.Context, name string, caps *ori.MachineResources) (*ori.MachineClass, error) {
	g.mu.RLock()
	defer g.mu.RUnlock()
