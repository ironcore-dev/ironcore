...
func machineAnnotatorEventHandler[O orievent.Object](log logr.Logger, c chan<- event.GenericEvent) orievent.HandlerFuncs[O] {
	handleEvent := func(obj orievent.Object) {
