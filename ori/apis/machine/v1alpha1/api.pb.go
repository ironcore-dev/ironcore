...
type NetworkSpec struct {
	...
	Peerings             []string `protobuf:"bytes,2,rep,name=peerings,proto3" json:"peerings,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *NetworkSpec) GetPeerings() []string {
	if m != nil {
		return m.Peerings
	}
	return nil
...
type UpdateNetworkPeeringsRequest struct {
	Handle               string   `protobuf:"bytes,1,opt,name=handle,proto3" json:"handle,omitempty"`
	Peerings             []string `protobuf:"bytes,2,rep,name=peerings,proto3" json:"peerings,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *UpdateNetworkPeeringsRequest) Reset()      { *m = UpdateNetworkPeeringsRequest{} }
func (*UpdateNetworkPeeringsRequest) ProtoMessage() {}
func (*UpdateNetworkPeeringsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{62}
}
func (m *UpdateNetworkPeeringsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateNetworkPeeringsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateNetworkPeeringsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateNetworkPeeringsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateNetworkPeeringsRequest.Merge(m, src)
}
func (m *UpdateNetworkPeeringsRequest) XXX_Size() int {
	return m.Size()
}
func (m *UpdateNetworkPeeringsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateNetworkPeeringsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateNetworkPeeringsRequest proto.InternalMessageInfo

func (m *UpdateNetworkPeeringsRequest) GetHandle() string {
	if m != nil {
		return m.Handle
	}
	return ""
...
func (m *UpdateNetworkPeeringsRequest) GetPeerings() []string {
	if m != nil {
		return m.Peerings
	}
	return nil
...
type UpdateNetworkPeeringsResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *UpdateNetworkPeeringsResponse) Reset()      { *m = UpdateNetworkPeeringsResponse{} }
func (*UpdateNetworkPeeringsResponse) ProtoMessage() {}
func (*UpdateNetworkPeeringsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{63}
}
func (m *UpdateNetworkPeeringsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateNetworkPeeringsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateNetworkPeeringsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateNetworkPeeringsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateNetworkPeeringsResponse.Merge(m, src)
}
func (m *UpdateNetworkPeeringsResponse) XXX_Size() int {
	return m.Size()
}
func (m *UpdateNetworkPeeringsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateNetworkPeeringsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateNetworkPeeringsResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*UpdateNetworkPeeringsRequest)(nil), "machine.v1alpha1.UpdateNetworkPeeringsRequest")
	proto.RegisterType((*UpdateNetworkPeeringsResponse)(nil), "machine.v1alpha1.UpdateNetworkPeeringsResponse")
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
type MachineRuntimeClient interface {
	...
	UpdateNetworkPeerings(ctx context.Context, in *UpdateNetworkPeeringsRequest, opts ...grpc.CallOption) (*UpdateNetworkPeeringsResponse, error)
...
func (c *machineRuntimeClient) UpdateNetworkPeerings(ctx context.Context, in *UpdateNetworkPeeringsRequest, opts ...grpc.CallOption) (*UpdateNetworkPeeringsResponse, error) {
	out := new(UpdateNetworkPeeringsResponse)
	err := c.cc.Invoke(ctx, "/machine.v1alpha1.MachineRuntime/UpdateNetworkPeerings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MachineRuntimeServer interface {
	...
	UpdateNetworkPeerings(context.Context, *UpdateNetworkPeeringsRequest) (*UpdateNetworkPeeringsResponse, error)
...
func (*UnimplementedMachineRuntimeServer) UpdateNetworkPeerings(ctx context.Context, req *UpdateNetworkPeeringsRequest) (*UpdateNetworkPeeringsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateNetworkPeerings not implemented")
}
...
func _MachineRuntime_UpdateNetworkPeerings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateNetworkPeeringsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MachineRuntimeServer).UpdateNetworkPeerings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/machine.v1alpha1.MachineRuntime/UpdateNetworkPeerings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineRuntimeServer).UpdateNetworkPeerings(ctx, req.(*UpdateNetworkPeeringsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MachineRuntime_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateNetworkPeerings",
			Handler:    _MachineRuntime_UpdateNetworkPeerings_Handler,
		},
		{
...
func (m *NetworkSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Peerings) > 0 {
		for iNdEx := len(m.Peerings) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Peerings[iNdEx])
			copy(dAtA[i:], m.Peerings[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.Peerings[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *UpdateNetworkPeeringsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateNetworkPeeringsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateNetworkPeeringsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateNetworkPeeringsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateNetworkPeeringsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateNetworkPeeringsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateNetworkPeeringsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateNetworkPeeringsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *NetworkSpec) String() string {
	...
	s := strings.Join([]string{`&NetworkSpec{`,
		`Handle:` + fmt.Sprintf("%v", this.Handle) + `,`,
		`Peerings:` + fmt.Sprintf("%v", this.Peerings) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *UpdateNetworkPeeringsRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateNetworkPeeringsRequest{`,
		`Handle:` + fmt.Sprintf("%v", this.Handle) + `,`,
		`Peerings:` + fmt.Sprintf("%v", this.Peerings) + `,`,
		`}`,
	}, "")
...
func (this *UpdateNetworkPeeringsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateNetworkPeeringsResponse{`,
		`}`,
	}, "")
	return s
}
...
func (m *NetworkSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Peerings = append(m.Peerings, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
func (m *UpdateNetworkPeeringsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateNetworkPeeringsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateNetworkPeeringsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateNetworkPeeringsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateNetworkPeeringsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateNetworkPeeringsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
